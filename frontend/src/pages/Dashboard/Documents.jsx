  ...
  return (
    <UptoPage>
      <UptoHero
        ...
        actions={<label className="cursor-pointer"><UptoButton as="span"><Upload className="mr-1 h-4 w-4 inline" /> {uploading ? "Uploading..." : "Upload"}</UptoButton><input type="file" className="hidden" onChange={handleUpload} /></label>}
      />
      <UptoCard>
        {loading && <UptoSpinner />}
